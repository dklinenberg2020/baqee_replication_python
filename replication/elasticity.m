...
Emin = 0.85; Emax = 1.05; N=501;
E = linspace(E_after_drop-0.05,Emax,N)';
...
legend('$\sigma=0$ (Leontief)','$\sigma=0.04$','$\sigma=0.1$','$\sigma=1$ (Cobb-Douglas)','Fontsize',16,'Location','SouthEast')
grid
xlim([Emin Emax])
ylim([Emin 1.02])
set(gca,'FontSize',16)
...
print -dpdf elasticity_fig.pdf
print -depsc elasticity_fig.eps
...
legend('$\sigma=0$ (Leontief)','$\sigma=0.04$','$\sigma=0.1$','$\sigma=1$ (Cobb-Douglas)','Fontsize',16,'Location','NorthEast')
grid
xlim([Emin Emax])
ylim([0.5 10])
set(gca,'FontSize',16)
...
print -dpdf MPE_fig.pdf
print -depsc MPE_fig.eps
...
print -dpdf MPX_fig.pdf
print -depsc MPX_fig.eps
...
print -dpdf exp_share_fig.pdf
print -depsc exp_share_fig.eps
